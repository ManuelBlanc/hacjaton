var Spritesheet = (function () {
    ...
    var rendermode_default = function (contextinput, contextoutput) {
        ...
        contextoutput.drawImage(
            contextinput.canvas,
            0,
            (contextoutput.canvas.height - contextinput.canvas.height * contextoutput.canvas.width / contextinput.canvas.width) / 2,
            contextoutput.canvas.width,
            (contextinput.canvas.height * contextoutput.canvas.width / contextinput.canvas.width)
        );
    };
